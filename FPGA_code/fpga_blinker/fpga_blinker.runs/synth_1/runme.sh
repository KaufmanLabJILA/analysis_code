...
HD_PWD='A:/heap/Analysis_code/fpga_blinker/fpga_blinker.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_blinker.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpga_blinker.tcl
