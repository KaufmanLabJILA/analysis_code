...
HD_PWD='A:/heap/Analysis_code/fpga_blinker/fpga_blinker.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_blinker.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fpga_blinker.tcl -notrace
