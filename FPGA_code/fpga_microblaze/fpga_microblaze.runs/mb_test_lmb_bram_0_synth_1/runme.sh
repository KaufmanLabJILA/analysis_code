...
HD_PWD='A:/heap/Analysis_code/FPGA code/fpga_microblaze/fpga_microblaze.runs/mb_test_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_test_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_test_lmb_bram_0.tcl
