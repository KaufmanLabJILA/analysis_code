...
HD_PWD='A:/heap/Analysis_code/FPGA code/fpga_microblaze/fpga_microblaze.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_test_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mb_test_wrapper.tcl -notrace
